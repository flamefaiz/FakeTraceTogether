...
import com.controller.BusinessLoginController;
import javax.swing.JOptionPane;

public class BusinessLoginUI extends javax.swing.JFrame {

    public BusinessLoginUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        fttMainTextLabel.setText("Business User Login");
        ...
        loginPanelLayout.setHorizontalGroup(
            ...
            .addGroup(loginPanelLayout.createSequentialGroup()
                .addGroup(loginPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(loginPanelLayout.createSequentialGroup()
                        .addGap(32, 32, 32)
                        .addComponent(fttMainTextLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 347, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        if(username.matches(usernamePattern))
        {
            ...
            BusinessLoginController businessLoginController = new BusinessLoginController();
            boolean result = businessLoginController.login("Business", username, password);

            if (result == true) {
                JOptionPane.showMessageDialog(null, "You have successfully logged in");
                BusinessUserUI bUU = new BusinessUserUI(username);
                bUU.setVisible(true);
                bUU.pack();
                bUU.setLocationRelativeTo(null);
                this.dispose();
            } else {
